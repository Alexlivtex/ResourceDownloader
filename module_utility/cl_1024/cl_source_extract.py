...
def getConfig(param_list, configType):
    ...
    item_param_list["id"] = param_list["id"]
    item_param_list["passwd"] = param_list["password"]
    item_param_list["data"] = os.path.join(param_list["data_path"], param_list[configType]["data_name"])
    item_param_list["bakData"] = os.path.join(param_list["data_path"], param_list[configType]["data_name_bak"])
    item_param_list["errorData"] = os.path.join(param_list["data_path"], param_list[configType]["error_data"])
    item_param_list["section"] = param_list[configType]["section_code"]
    item_param_list["counting"] = param_list[configType]["ranking_count"]
